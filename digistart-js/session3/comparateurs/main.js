...
var isNeighbourYounger = neighbourAge < myAge;
console.log(isNeighbourYounger);
...
function showGreaterNumber(number1, number2) {
    var greaterNumber = Math.max(number1, number2);
    console.log(greaterNumber);
}


// 2. L'exécuter avec les paramètres de votre choix.
showGreaterNumber(255, 120);
...
console.log(isBetween1000And3000(1500));